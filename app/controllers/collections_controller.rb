class CollectionsController < ApplicationController
    ...
    def bulk_destroy
      ...
      unless deleted_collections_count == 1
        flash[:alert] = "#{deleted_collections_count} collections were deleted successfully."
      else
        flash[:alert] = "#{deleted_collections_count} collection were deleted successfully."
      end
      redirect_to collections_path 
    end
